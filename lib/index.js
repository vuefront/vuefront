...
const MainConfig = {
  ...
  molecules: {
    ...
    Col: 'mCol',
    Dropdown: 'mDropdown',
    DropdownItem: 'mDropdownItem',
    //Dropdown
    Empty: 'mEmpty',
    Field: 'mField',
    InputGroup: 'mInputGroup',
    ListGroup: 'mListGroup',
    ListGroupItem: 'mListGroupItem',
    //ListGroup
    LocationThumb: 'mLocationThumb',
    Logo: 'mLogo',
    Media: 'mMedia',
    MediaAside: 'mMediaAside',
    //Media
    MediaBody: 'mMediaBody',
    //Media
    PostImage: 'mPostImage',
    PostNav: 'mPostNav',
    PostThumb: 'mPostThumb',
    PostThumbImage: 'mPostThumbImage',
    //PostThumb
    PostThumbInline: 'mPostThumbInline',
    ProductAttribute: 'mProductAttribute',
    ProductImage: 'mProductImage',
    ProductImagePopup: 'mProductImagePopup',
    //ProductImage
    ProductOptionCheckbox: 'mProductOptionCheckbox',
    //ProductOption
    ProductOptionDate: 'mProductOptionDate',
    //ProductOption
    ProductOptionDatetime: 'mProductOptionDateTime',
    //ProductOption
    ProductOptionFile: 'mProductOptionFile',
    //ProductOption
    ProductOptionRadio: 'mProductOptionRadio',
    //ProductOption
    ProductOptionSelect: 'mProductOptionSelect',
    //ProductOption
    ProductOptionText: 'mProductOptionText',
    //ProductOption
    ProductOptionTextarea: 'mProductOptionTextarea',
    //ProductOption
    ProductOptionTime: 'mProductOptionTime',
    //ProductOption
    ProductPrice: 'mProductPrice',
    ProductThumb: 'mProductThumb',
    ProductThumbImage: 'mProductThumbImage',
    //ProductThumb
