...
var _addToCompare = _interopRequireDefault(require("vuefront/graphql/store/compare/addToCompare.graphql"));

var _removeCompare = _interopRequireDefault(require("vuefront/graphql/store/compare/removeCompare.graphql"));

var _get = _interopRequireDefault(require("vuefront/graphql/store/compare/get.graphql"));
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return dispatch('apollo/mutate', {
                mutation: _addToCompare.default,
                variables: {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 4;
              return dispatch('apollo/mutate', {
                mutation: _removeCompare.default,
                variables: {
                  id: id
                }
              }, {
