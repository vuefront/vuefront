...
var __vue_render__ = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.product.options, function(option, index) {
      return _c(
        "div",
        { key: index, staticClass: "mb-5 mt-3" },
        [
          _c("div", {
            staticClass: "product-option__name h6 mt-5",
            domProps: { innerHTML: _vm._s(option.name) }
          }),
          _vm._v(" "),
          _c("vf-product-option-" + option.type, {
            tag: "div",
            attrs: { option: option, selected: _vm.selectedOptions },
            on: {
              change: function($event) {
                return _vm.handleOptionChange($event, option)
              }
            }
          })
        ],
