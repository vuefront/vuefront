...
var __vue_render__ = function() {
  ...
  return _c(
    "div",
    { staticClass: "account-login-section" },
    [
      _c(
        "b-card",
        ...
        [
            ...
            [
              _c("div", { staticClass: "mb-5" }, [
                _c("h6", { staticClass: "h3" }, [
                  _vm._v(
                    _vm._s(_vm.$t("elements.common.account.login.titleText"))
                  )
                ]),
                _vm._v(" "),
                _c("p", { staticClass: "text-muted mb-0" }, [
                  _vm._v(
                    _vm._s(_vm.$t("elements.common.account.login.subTitleText"))
                  )
                ])
              ]),
              _vm._v(" "),
                ...
                [
                  _c(
                    "b-form-group",
                    {
                      attrs: {
                        label: _vm.$t(
                          "elements.common.account.login.emailEntry"
                        ),
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            _vm._s(
                              _vm.$t("elements.common.account.login.emailError")
                            )
                          )
                        ]
                      )
                  ...
                  _c(
                    "b-form-group",
                    {
                      attrs: {
                        label: _vm.$t(
                          "elements.common.account.login.passwordEntry"
                        ),
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            _vm._s(
                              _vm.$t(
                                "elements.common.account.login.passwordError"
                              )
                            )
                          )
                        ]
                    ...
                    [
                      _c(
                        ...
                        [
                          _vm._v(
                            _vm._s(
                              _vm.$t("elements.common.account.login.buttonSave")
                            )
                          )
                        ]
                      )
          ...
          _c(
            ...
            [
              _c("small", [
                _vm._v(
                  _vm._s(_vm.$t("elements.common.account.login.footerText"))
                )
              ]),
              _vm._v(" "),
              _c(
                ...
                [
                  _vm._v(
                    _vm._s(_vm.$t("elements.common.account.login.footerLink"))
                  )
                ]
              )
            ],
...
__vue_render__._withStripped = true;
  ...
  var login = normalizeComponent_1(
