    ...
    scopedSlots: _vm._u([
      ...
      },
      {
        ...
        fn: function(ref) {
          var data = ref.data;
          return [
            data.searchPosts.content.length > 0
              ? _c(
                  "vf-post-module",
                  {
                    attrs: {
                  ...
                  [_vm._v(_vm._s(_vm.$t("modules.blog.searchPost.textTitle")))]
                )
              : _vm._e()
          ]
        }
...
__vue_render__._withStripped = true;
  ...
  var searchPost = normalizeComponent_1(
