    ...
    scopedSlots: _vm._u([
      {
        ...
        fn: function(ref) {
          ...
          return [
            _c(
              "div",
              { staticClass: "categoriesBlogList mb-4" },
              [
                _c(
                  "b-list-group",
                  [
                    _vm._l(data.categoriesBlogList.content, function(
                      value,
                      index
                    ) {
                      return [
