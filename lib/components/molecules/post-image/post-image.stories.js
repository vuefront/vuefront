...
Vue.component('vfMPostImage', vfMPostImage);
export var post = {
  "id": "1",
  ...
  "datePublished": "Sunday 24 April 2016",
  "rating": 5,
  "categories": [{
    "id": "1",
    "name": "Blog",
  ...
  "next": {
    "id": "2",
    "name": "Big sale this summer",
    "image": "https://opencart.vuefront.com/image/cache/catalog/d_blog_module/post/Photo_blog_3-1200x750.jpg",
    "imageLazy": "https://opencart.vuefront.com/image/cache/catalog/d_blog_module/post/Photo_blog_3-10x7.jpg",
    "shortDescription": "Lorem ipsum dolor sit amet, justo aliquid reformidans ea vel, vim porro dictas et, ut elit partem invidunt vis. Saepe melius complectitur eum ea. Zril delenit vis ut. His suavitate rationibus in, tale discere ceteros eu nec. Vel ut utamur laoreet vituperata, in discere contentiones definitionem ius.",
    "keyword": "big-sale-this-summer"
  },
  "reviews": {
    "totalElements": 2,
    "content": [{
      "author": "admin",
      "author_email": "",
      "content": "Lorem ipsum dolor sit amet, justo aliquid reformidans ea vel, vim porro dictas et, ut elit partem invidunt vis. Saepe melius complectitur eum ea",
      "created_at": "2016-04-22 09:08:42",
      "rating": 5
    }, {
      "author": "admin",
      "author_email": "",
      "content": "Lorem ipsum dolor sit amet, justo aliquid reformidans ea vel, vim porro dictas et, ut elit partem invidunt vis. Saepe melius complectitur eum ea",
      "created_at": "2016-04-14 14:40:46",
      "rating": 5
    }]
  }
};
storiesOf('molecule|Post Image', module).add('default', function () {
  return {
    components: {
      vfMPostImage: vfMPostImage
    },
    template: "<vf-m-post-image :post=\"post\" :width=\"300\"/>",
    data: function data() {
      return {
        post: post
      };
