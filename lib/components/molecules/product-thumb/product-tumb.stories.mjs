import VfMProductThumb from "./product-thumb.vue.mjs";
import "./product-thumb.scss.mjs"; // More on default export: https://storybook.js.org/docs/vue/writing-stories/introduction#default-export

export default {
  title: "molecule/product-thumb",
  component: VfMProductThumb,
...
const Template = args => ({
  ...
  template: `<vf-m-product-thumb v-bind="args" :style="{width: args.wide ? null : '300px'}"/>`
});
