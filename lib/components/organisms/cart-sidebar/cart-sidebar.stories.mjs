import VfOCartSidebar from "./cart-sidebar.vue.mjs";
...
const Template = args => ({
  ...
  template: '<vf-o-cart-sidebar v-bind="args"/>'
});
...
//# sourceMappingURL=cart-sidebar.stories.mjs.map