import VfOCartProducts from "./cart-products.vue.mjs";
...
const Template = args => ({
  ...
  template: '<vf-o-cart-products v-bind="args"/>'
});
...
//# sourceMappingURL=cart-products.stories.mjs.map