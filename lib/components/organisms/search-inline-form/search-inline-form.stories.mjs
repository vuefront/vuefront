import VfOSearchInlineForm from "./search-inline-form.vue.mjs"; // More on default export: https://storybook.js.org/docs/vue/writing-stories/introduction#default-export
