export default {
  ...
  components: {
    ...
    ProductOptionDate:    'vuefront/lib/components/elements/store/option/date',
    ProductOptionTime:    'vuefront/lib/components/elements/store/option/time',
    ProductOptionDatetime:'vuefront/lib/components/elements/store/option/datetime',
    ProductOptionText:    'vuefront/lib/components/elements/store/option/text',
    ProductOptionFile:    'vuefront/lib/components/elements/store/option/file',
    ProductOptionTextarea:'vuefront/lib/components/elements/store/option/textarea',
    ProductOptionSelect:  'vuefront/lib/components/elements/store/option/select',
    ProductOptionRadio:   'vuefront/lib/components/elements/store/option/radio',
    ProductOptionCheckbox:'vuefront/lib/components/elements/store/option/checkbox',
