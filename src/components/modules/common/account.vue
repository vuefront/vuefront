<template>
  <section class="module-common-account mb-4">
    <b-list-group>
      ...
      <b-list-group-item v-if="auth" to="/account/password">{{$t('modules.common.account.passwordText')}}</b-list-group-item>
      <b-list-group-item v-if="auth" to="/account/address">{{$t('modules.common.account.addressText')}}</b-list-group-item>
